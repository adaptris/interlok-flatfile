...
public class FieldHandler extends Handler {
  ...
  /**
   * process - function which receives a record and reads the next field from it according to the definition read from the message
   * descriptor.
   *
   * @param inputRecord
   *          - the StreamParser to read the record from
   * @param output
   *          - the StringBuffer to receive the output
   */
  @Override
